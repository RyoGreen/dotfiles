...
let s:palette.comment   = {'dark': "#00ffff",  'light': "#5c6e73",  'mirage': "#5c6e73"}
let s:palette.markup    = {'dark': "#00ffff",  'light': "#5c6e73",  'mirage': "#5c6e73"}
...
let s:palette.accent    = {'dark': "#FF3333",  'light': "#FF6A00",  'mirage': "#FFCC66"}
let s:palette.panel     = {'dark': "#14191F",  'light': "#FFFFFF",  'mirage': "#272D38"}
let s:palette.guide     = {'dark': "#4682b4",  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.line      = {'dark': "#151A1E",  'light': "#F3F3F3",  'mirage': "#242B38"}
let s:palette.selection = {'dark': "#717D7E",  'light': "#F0EEE4",  'mirage': "#343F4C"}
