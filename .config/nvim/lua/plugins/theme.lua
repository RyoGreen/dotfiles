...
if status then
    tokyonight.setup({
        ...
        sidebars = { "qf", "help", "terminal", "NvimTree", "TelescopePrompt", "TelescopeResults", "Trouble" }, -- Set a darker background on sidebar-like windows
    ...
    -- Fallback to a basic dark theme if Tokyo Night is not available
