...
augroup TypescriptMappings
    ...
    autocmd FileType typescript nmap <silent> <leader>i <Plug>(coc-implementation)
    autocmd FileType typescript nmap <silent> <leader>r <Plug>(coc-references)
    autocmd FileType typescript nnoremap <buffer> <C-t> <C-o>
augroup END
augroup RustMappings
    autocmd!
    autocmd FileType rust nmap <silent> <leader>i <Plug>(coc-implementation)
    autocmd FileType rust nmap <silent> <leader>r <Plug>(coc-references)
